...
function RenderLeader({leader}) {
  ...
  function About(props) {
    ...
    function LoadLeader(prop) {
      console.log(prop.prop, "MIAAA");
        if (prop.prop.leadersLoading) {
              return(
                  <Loading />
              );
        }
        else if (prop.prop.leadersErrMess) {
              return(
                  <h4>{prop.prop.leadersErrMess}</h4>
              );
        }
        else if (prop.prop.leader) {
          return(
            <Stagger in>
              {prop.prop.leader.map((leader) => {
                return (
                  <Fade in>
